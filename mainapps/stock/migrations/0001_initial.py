    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.CharField(blank=True, help_text='Stock keeping unit for this stock item', max_length=100, null=True, validators=[mainapps.utils.validators.validate_serial_number], verbose_name='Stock keeping unit')),
                ...
                ('status', models.PositiveIntegerField(choices=[(10, 'OK'), (50, 'Attention needed'), (55, 'Damaged'), (60, 'Destroyed'), (65, 'Rejected'), (70, 'Lost'), (75, 'Quarantined'), (85, 'Returned')], default=10, help_text='Status of this StockItem ', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Status')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('inventory', 'name'), name='unique_location_name_per_inventory'),
        ),
    ]
