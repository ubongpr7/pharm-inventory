...
# class DrabtRestURLField(RestURLField):
...
#         strict_urls = common.models.DrabtSetting.get_setting(
...
# class DrabtURLField(models.URLField):
#     """Custom URL field which has custom scheme validators."""

#     default_validators = [AllowedURLValidator()]

#     def __init__(self, **kwargs):
#         """Initialization method for DrabtURLField."""
#         # Max length for DrabtURLField is set to 200
#         kwargs['max_length'] = 200
#         super().__init__(**kwargs)
...
# class DrabtModelMoneyField(ModelMoneyField):
...
#         kwargs['form_class'] = DrabtMoneyField
...
# class DrabtMoneyField(MoneyField):
#     """Custom MoneyField for clean migrations while using dynamic currency settings."""
...
#             value = Drabt.helpers.normalize(value)
...
# class DrabtNotesField(models.TextField):
...
#         super().__init__(**kwargs)
# help me regenerate the code below with a complete documentation and improve the related_names where there is Foreignkey